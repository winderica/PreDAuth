...
const setup = (mod, curveType) => {
    ...
    */
    ...
    class Common {
        ...
        deserializeHexStr(s) {
            this.deserialize(e.fromHexStr(s))
        }
    ...
    e.deserializeHexStrToFr = s => {
        const r = new e.Fr()
        r.deserializeHexStr(s)
        return r
    }
    e.Fp = class extends Common {
        constructor() {
            super(MCLBN_FP_SIZE)
        }
    ...
    e.deserializeHexStrToFp = s => {
        const r = new e.Fp()
        r.deserializeHexStr(s)
        return r
    }
    e.Fp2 = class extends Common {
        constructor() {
    ...
    e.deserializeHexStrToFp2 = s => {
        const r = new e.Fp2()
        r.deserializeHexStr(s)
        return r
    }
    e.G1 = class extends Common {
        constructor() {
            super(MCLBN_G1_SIZE)
        }
    ...
    e.deserializeHexStrToG1 = s => {
        const r = new e.G1()
        r.deserializeHexStr(s)
        return r
    }
    e.setETHserialization = (ETHserialization) => {
        mod._mclBn_setETHserialization(ETHserialization ? 1 : 0)
    }
    e.verifyOrderG1 = (doVerify) => {
        mod._mclBn_verifyOrderG1(doVerify ? 1 : 0)
    }
    e.verifyOrderG2 = (doVerify) => {
    ...
    e.deserializeHexStrToG2 = s => {
        const r = new e.G2()
        r.deserializeHexStr(s)
        return r
    }
    e.GT = class extends Common {
        constructor() {
            super(MCLBN_GT_SIZE)
        }
    ...
    e.deserializeHexStrToGT = s => {
        const r = new e.GT()
        r.deserializeHexStr(s)
        return r
    }
    e.PrecomputedG2 = class {
        constructor(Q) {
            if (!(Q instanceof e.G2)) throw new Error('PrecomputedG2:bad type')
    ...
    */
    e.mul = (x, y) => {
        if (x instanceof e.Fr && y instanceof e.Fr) {
            return x._op2(mod._mclBnFr_mul, y)
        }
        if (x instanceof e.G1 && y instanceof e.Fr) {
            return x._op2(mod._mclBnG1_mul, y)
        }
        if (x instanceof e.G2 && y instanceof e.Fr) {
            return x._op2(mod._mclBnG2_mul, y)
        }
        if (x instanceof e.GT && y instanceof e.GT) {
    ...
    // pow(GT x, Fr y)
    e.pow = (x, y) => {
        if (x instanceof e.GT && y instanceof e.Fr) {
    ...
    // pairing(G1 P, G2 Q)
    e.pairing = (P, Q) => {
        if (P instanceof e.G1 && Q instanceof e.G2) {
            return P._op2(mod._mclBn_pairing, Q, e.GT)
        }
    ...
    e.millerLoop = (P, Q) => {
        if (P instanceof e.G1 && Q instanceof e.G2) {
            return P._op2(mod._mclBn_millerLoop, Q, e.GT)
        }
        throw new Error('exports.millerLoop:bad type')
    }
    e.precomputedMillerLoop = (P, Qcoeff) => {
        if (!(P instanceof e.G1 && Qcoeff instanceof e.PrecomputedG2)) throw new Error('exports.precomputedMillerLoop:bad type')
        const e = new e.GT()
    ...
    e.precomputedMillerLoop2 = (P1, Q1coeff, P2, Q2coeff) => {
        if (!(P1 instanceof e.G1 && Q1coeff instanceof e.PrecomputedG2 && P2 instanceof e.G1 && Q2coeff instanceof e.PrecomputedG2)) throw new Error('exports.precomputedMillerLoop2mixed:bad type')
        const e = new e.GT()
    ...
    e.precomputedMillerLoop2mixed = (P1, Q1, P2, Q2coeff) => {
        if (!(P1 instanceof e.G1 && Q1 instanceof e.G2 && P2 instanceof e.G1 && Q2coeff instanceof e.PrecomputedG2)) throw new Error('exports.precomputedMillerLoop2mixed:bad type')
        const e = new e.GT()
        const P1Pos = P1._allocAndCopy()
...
exports.init = (curveType = exports.BN254) => {
    const mcl = getUnitSize(curveType) === 4 ? mcl_c : mcl_c512
